        ...
        switch (materialName) {
          case "bladeCoating":
            updateMaterial(child.material, materialName, {
              ...
              colorMapUrl: snap.bladeCoatingColor.colorMap?.fileUrl,
              roughnessMapUrl: snap.bladeCoatingColor.roughnessMap?.fileUrl,
              normalMapUrl: snap.bladeCoatingColor.normalMap?.fileUrl,
            });
            break;
        ...
        switch (materialName) {
          ...
          case "sheath":
            updateMaterial(child.material, materialName, {
              ...
              colorMapUrl: snap.sheathColor.colorMap?.fileUrl,
              roughnessMapUrl: snap.sheathColor.roughnessMap?.fileUrl,
              normalMapUrl: snap.sheathColor.normalMap?.fileUrl,
            });
            break;
        }
      }
      ...
      {engravingMeshes.map((mesh, idx) => {
        return (
          <EngravedMesh
            ...
            engravings={snap.engravings as EngravingForCanvas[]}
          />
        );
      })}
      {/*@ts-ignore*/}
