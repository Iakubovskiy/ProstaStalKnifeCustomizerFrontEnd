...
const CardComponent: React.FC<CardComponentProps> = ({ backgroundPicture, tooltipText, onClick }) => {
    const isColor = (value: string) => /^#([0-9A-F]{3}){1,2}$/i.test(value) || /^rgb|rgba/.test(value);
    return (
        <div>
