...
const AttachmentTypeListPage = () => {
  ...
  const filteredAndSortedData = useMemo(() => {
    ...
    filtered.sort((a, b) => {
      const aValue = a.names?.[locale] || "";
      const bValue = b.names?.[locale] || "";
    ...
    return filtered;
  }, [attachmentTypes, searchTerm, sortField, sortDirection, locale]);
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 mb-6 border border-[#b8845f]/20 shadow-sm">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            ...
            <button
              onClick={() => router.push("/attachmentType/0")}
                  ...
                  >
                    ...
                    <td className="p-4">
                      <div className="flex items-center justify-center space-x-2">
                        <button
                          onClick={() =>
                            router.push(`/attachmentType/${item.id}`)
                          }
...
export default AttachmentTypeListPage;
