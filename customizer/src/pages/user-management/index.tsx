            ...
            <div className="max-w-7xl mx-auto">
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 mb-6 border border-[#b8845f]/20 shadow-sm">
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                        ...
                        <button
                            onClick={() => router.push("/user-management/0")}
                        ...
                        >
                            <Plus />
                            <span>Створити адміністратора</span>
                        </button>
                    </div>
                </div>
                        ...
                        <table className="w-full">
                            ...
                            {paginatedData.map((item) => (
                                ...
                                >
                                    ...
                                    <td className="p-4 text-[#2d3748]">
                                        {item.userData?.clientPhoneNumber || "–"}
                                    </td>
                                    <td className="p-4">
                                        <Chip
